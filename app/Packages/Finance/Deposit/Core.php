...
class Core {
    ...
    {
        switch ($this->deposit->plow_back) {

            case PlowBack::DAILY :
                return $this->monthlyProfitByDay($year, $month, $balance);

            case PlowBack::WEEKLY  :
                return $this->monthlyProfitByWeek($month, $balance);

            case PlowBack::MONTHLY  :
                return $balance * $this->deposit->percent / 100 / 12;
