            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('manage.wallet.destroy', $wallet->wallet_id) }}">
                            @csrf
                            @method('DELETE')

                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <a href="{{ route('manage.wallet.index') }}" class="btn btn-secondary me-md-2">{{ __('Назад') }}</a>
                                <a href="{{ route('payment.wallet.create', $wallet->wallet_id) }}" class="btn btn-primary me-md-2">{{ __('Транзакция') }}</a>
                                <a href="{{ route('manage.wallet.edit', $wallet->wallet_id) }}" class="btn btn-warning me-md-2">{{ __('Изменить') }}</a>
