                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-title">
                            <form method="get" action="{{ route('manage.wallet.index') }}">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                    ...
                                    <a href="{{ route('manage.wallet.index') }}" class="btn btn-secondary">{{ __('Сброс') }}</a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                            <a href="{{ route('manage.wallet.create') }}" class="btn btn-primary">{{ __('Добавить кошелек') }}</a>
                        </div>
