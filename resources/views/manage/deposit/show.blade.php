            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \App\Classes\Helper::plowBackText($deposit->plow_back ?? 0) }}</td>
                                </tr>
                                <tr>
                        ...
                        <form method="post" action="{{ route('manage.deposit.destroy', $deposit->deposit_id) }}">
                            @csrf
                            @method('DELETE')

                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <a href="{{ route('manage.deposit.index') }}" class="btn btn-secondary me-md-2">Назад</a>
                                <a href="{{ route('manage.deposit.edit', $deposit->deposit_id) }}" class="btn btn-warning me-md-2">Изменить</a>
                        ...
                        <table class="table table-striped mt-3">
                            ...
                            <tr>
                                <th>{!! Icons::get(Icons::CASH) !!} {{ __('Итого к выплате') }}</th>
