                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    <tr>
                                        ...
                                        <td data-label="Название"><a class="text-decoration-none text-primary" href="{{ route('manage.deposit.show', $deposit->deposit->deposit_id) }}">{{ $deposit->deposit->title ?? '' }}</a></td>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                            <a href="{{ route('manage.deposit.create') }}" class="btn btn-primary">Добавить вклад</a>
                        </div>
