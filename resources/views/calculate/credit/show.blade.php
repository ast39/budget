                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <table class="table table-striped admin-table__adapt admin-table__instrument">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-end">{{ __('Сумма платежа') }}</th>
                        ...
                        <div class="d-grid gap-2 d-md-flex mt-3 justify-content-md-center">
                            <a href="{{ route('calculate.credit.create') }}" class="btn btn-secondary me-md-2">Рассчитать новый кредит</a>
                        </div>
